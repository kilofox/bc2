...
<html>
	<head>
		...
		<meta name="description" content="BootCMS 是内容管理系统。"/>
		<meta name="keywords" content="BootCMS, cms, php, 内容管理"/>
		<meta name="author" content="Tinsh 与 BootCMS 贡献者"/>
		<link rel="shortcut icon" type="image/x-icon" href="<?php echo $baseUrl; ?>/favicon.ico"/>
		<title>首页 - BootCMS</title>
		...
		<link href="<?php echo $baseUrl; ?>/assets/default/css/global.css" rel="stylesheet"/>
	</head>
	<body>
		<div id="header">
		...
		<div id="footer">
			...
			<p class="copyright">
				Copyright &copy; Untitled. All rights reserved. Powered by <a href="http://bootcms.kilofox.net" target="_blank">BootCMS</a>, based on <a href="http://www.kilofox.net/bootphp" target="_blank">BootPHP</a>.
			</p>
		</div>
		<script>
			$(function(){
