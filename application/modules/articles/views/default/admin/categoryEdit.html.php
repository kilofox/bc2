<div class="cell auto-size padding20 bg-white" id="cell-content">
    <h1 class="text-light">编辑分类 <span class="mif-drive-eta place-right"></span></h1>
    <hr class="thin bg-grayLighter">
    <form id="edit">
        <div class="tabcontrol" data-role="tabcontrol">
            <ul class="tabs">
                <li class="active"><a href="#frame_1">编辑分类</a></li>
            </ul>
            <div class="frames">
                <div class="frame" id="frame_1">
                    ...
                    <lable>别名</lable>
                    <div class="input-control text full-size">
                        <input type="text" name="slug" value="<?php echo $node->slug; ?>"/>
                    </div>
                    <lable>描述</lable>
                    <div class="input-control text full-size">
...
<script>
    ...
    $(function () {
        $('#edit').submit(function () {
            ...
            $.ajax({
                url: baseUrl + '/articles/admin/category/<?php echo $node->id; ?>/edit',
                type: 'put',
                dataType: 'json',
                data: $('#edit').serialize(),
                success: function (r) {
