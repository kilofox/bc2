<div class="cell auto-size padding20 bg-white" id="cell-content">
    <h1 class="text-light">文章 <span class="mif-drive-eta place-right"></span></h1>
    <hr class="thin bg-grayLighter">
    <button class="button primary" onclick="pushMessage('info')"><span class="mif-plus"></span> 创建</button>
    ...
    <button class="button alert" onclick="pushMessage('alert')">停止所有机器</button>
    <hr class="thin bg-grayLighter">
        ...
        <tbody>
            <?php foreach ($nodes as $node): ?>
                <tr>
                    ...
                    <td><a href="<?php echo $baseUrl; ?>/articles/<?php echo $node->slug; ?>" target="_blank"><?php echo $node->title; ?></a></td>
                    <td><?php echo $node->created; ?></td>
                    <td class="align-center"><?php echo $node->status; ?></td>
                    <td class="align-center">
                        <a href="<?php echo $baseUrl; ?>/articles/admin/<?php echo $node->id; ?>/edit">编辑</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
