<div class="cell auto-size padding20 bg-white" id="cell-content">
	<h1 class="text-light">虚拟机 <span class="mif-drive-eta place-right"></span></h1>
	...
	<table class="dataTable border bordered">
		<thead>
			<tr>
				...
				<td class="sortable-column">机器名</td>
				<td class="sortable-column">地址</td>
				<td class="sortable-column" style="width: 20px">状态</td>
				<td style="width: 20px">切换</td>
			</tr>
		</thead>
		<tbody>
			<tr>
				...
				<td style="-webkit-justify-content: flex-start;">123890723212</td>
				<td>机器号 1</td>
				<td><a href="">链接</a></td>
