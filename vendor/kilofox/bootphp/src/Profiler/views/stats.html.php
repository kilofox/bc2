<?php
namespace Bootphp\Profiler\views;
...
<div class="kohana">
    ...
    <table class="profiler">
        ...
        <tr class="final mark time">
            <th class="name" rowspan="2" scope="rowgroup">Application Execution (<?php echo $stats['count']; ?>)</th>
