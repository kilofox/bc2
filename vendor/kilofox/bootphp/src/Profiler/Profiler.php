...
/**
 * 提供简单的基准测试与性能分析。要显示收集到的统计信息，可直接添加代码：
 *
...
class Profiler
{
	...
	public static function start($group, $name)
	{
		static $counter = 0;
		// 根据这个记数器创建唯一令牌
		$token = 'bp/' . base_convert($counter++, 10, 32);
	...
	public static function application()
	{
		...
		$stats = Cache::instance()->get('profiler_application_stats');
		...
		// 缓存新的统计
		Cache::instance()->set('profiler_application_stats', $stats);
		// 设置当前应用的执行时间与内存使用
		// 不要缓存这些东西，它们只是针对当前请求
