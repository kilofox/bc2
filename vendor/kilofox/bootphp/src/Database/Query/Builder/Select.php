...
use Bootphp\Database\Query\Builder\Join;
/**
...
class Select extends Where
{
	...
	public function union($select, $all = true)
	{
		...
		if ( !$select instanceof Select )
			throw new \Bootphp\Exception\ExceptionHandler('first parameter must be a string or an instance of Database_Query_Builder_Select');
