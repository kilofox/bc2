...
class Insert extends Builder
{
	...
	{
		if ( !is_string($table) )
			throw new \Bootphp\Exception\ExceptionHandler('INSERT INTO syntax does not allow table aliasing');
		$this->_table = $table;
		return $this;
	}
	/**
	...
	public function compile($db = NULL)
	{
		...
		$query .= ' (' . implode(', ', array_map(array($db, 'quoteColumn'), $this->_columns)) . ') ';
		if ( is_array($this->_values) )
		{
